      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            ...
            return _context.abrupt("return", router.connect(false));
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            bestOrder = _lodash.default.omit(_reducers2.selectors.getCurrentFrameSelectedOrder(state) || _reducers2.selectors.getCurrentFrameBestOrder(state) || _reducers2.selectors.getCurrentFrameBestAlternativeOrder(state) || _reducers2.selectors.getCurrentFrameBestLowBalanceOrder(state), ['takerAmountFormatted', 'makerAmountFormatted']);
