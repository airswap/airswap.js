...
var getOnAndOffChainIntents = _selectors.getLocatorIntentsFormatted;
/*
...
var getAvailableMarketsByBaseTokenAddress = (0, _reselect.createSelector)(getConnectedIndexerIntents, function (intents) {
  var markets = {};

  _constants.BASE_ASSET_TOKEN_ADDRESSES.map(function (address) {
  ...
  intents.forEach(function (intent) {
    if (Object.prototype.hasOwnProperty.call(markets, intent.takerToken)) {
      ...
      if (intent.takerToken === _constants.WETH_CONTRACT_ADDRESS) {
        markets[_constants.ETH_ADDRESS].add(intent.makerToken);
      }
    }
    ...
    if (Object.prototype.hasOwnProperty.call(markets, intent.makerToken)) {
      ...
      if (intent.makerToken === _constants.WETH_CONTRACT_ADDRESS) {
        markets[_constants.ETH_ADDRESS].add(intent.takerToken);
      }
    }
  });
  return _lodash.default.mapValues(markets, function (market) {
    return market.size;
  });
});
/*
