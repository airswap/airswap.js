...
var _actions = require("../../ledger/redux/actions");

var _actions2 = require("../../HDW/redux/actions");
...
function connectLedger(_x) {
  return _connectLedger.apply(this, arguments);
}

function _connectLedger() {
  _connectLedger = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(store) {
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            store.dispatch((0, _actions2.initializeHDW)('ledger')).then(
            /*#__PURE__*/
            function () {
              var _ref5 = _asyncToGenerator(
              /*#__PURE__*/
              regeneratorRuntime.mark(function _callee3(_ref4) {
                var path, ledgerProvider, addressPromise;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        _context3.prev = 1;
                        _context3.next = 4;
                        return store.dispatch((0, _actions.getLedgerProvider)(path));

                      case 4:
                        ledgerProvider = _context3.sent;
                        _context3.next = 10;
                        break;
                      ...
                      case 10:
                        ...
                        signer = (0, _getSigner.default)({
                          web3Provider: ledgerProvider
                        }, walletActions);
                        addressPromise = signer.getAddress();
                        addressPromise.then(function (address) {
                          return store.dispatch(connectedWallet('ledger', address.toLowerCase()));
                        });
              ...
              return store.dispatch(errorConnectingWallet((0, _transformations.formatErrorMessage)(e)));
            });
...
function () {
  ...
  return function startWalletAction(_x2, _x3, _x4) {
...
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return _context2.abrupt("return", walletsAvailable);
  ...
  return function detectWeb3Wallets(_x5) {
      ...
      switch (expressLoginCredentials.walletType // this switch statement allows us to write adaptors to determine wallet availability
        ...
        case 'equal':
          ...
          if ((_lodash.default.first(res.result) || '').toLowerCase() === expressLoginCredentials.address) {
            store.dispatch((0, _actions3.connectWallet)(expressLoginCredentials.walletType));
          }
