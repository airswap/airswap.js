...
var getDelegateProvidedOrders = (0, _reselect.createSelector)(_eventTrackingSelectors.getDelegateProvideOrderEvents, function (events) {
  return events.map(function (_ref4) {
    ...
    var atomicPrice = (0, _utils.getAtomicPriceFromContractPrice)({
    ...
    var _getAtomicAmountsFrom = (0, _utils.getAtomicAmountsFromAtomicPrice)(atomicPrice),
        signerAmount = _getAtomicAmountsFrom.signerAmountAtomic;
