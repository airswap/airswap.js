...
var initPollExchangeFills = _lodash.default.once(function (store) {
  ...
  if (_constants.IS_INSTANT || _constants.IS_EXPLORER) {
    _websocketEventTracker.default.trackEvent((0, _eventTrackingActions2.trackSwapLegacyFilled)({
      callback: callback,
      backFillBlockCount: 7000
    }));

    _websocketEventTracker.default.trackEvent((0, _eventTrackingActions.trackSwapSwap)({
      callback: callback,
      backFillBlockCount: 7000
    }));
  } else {
    ...
    _websocketEventTracker.default.trackEvent((0, _eventTrackingActions.trackSwapCancel)({
      callback: callback,
      fromBlock: _constants.SWAP_CONTRACT_DEPLOY_BLOCK
    }));
  }
    ...
    return function (action) {
      switch (action.type) {
        ...
        case 'TRACK_EVENT':
          ...
          _websocketEventTracker.default.trackEvent(_objectSpread({}, action, {
