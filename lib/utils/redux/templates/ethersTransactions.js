...
var provider = new _ethers.ethers.providers.JsonRpcProvider(_constants.AIRSWAP_GETH_NODE_ADDRESS);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            _context.prev = 16;
            _context.next = 19;
            return provider.waitForTransaction(txn.hash).then(function () {
