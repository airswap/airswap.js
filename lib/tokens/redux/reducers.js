...
var makeGetReadableSwapOrder = (0, _reselect.createSelector)(getTokensByAddress, makeFullByToken, makeParseByToken, function (tokenByAddress, fullByToken, parseByToken) {
  return function (order, baseAsset) {
    return _index.default.ready ? _index.default.getReadableSwapOrder(order, tokenByAddress, fullByToken, parseByToken, baseAsset) : [];
  };
});
...
var getBaseTokens = (0, _reselect.createSelector)(getTokensByAddress, function (tokensByAddress) {
  var ret = {};

  _constants.BASE_ASSET_TOKEN_ADDRESSES.forEach(function (address) {
