...
var _require = require('../constants'),
    ...
    BASE_ASSET_TOKENS_SYMBOLS = _require.BASE_ASSET_TOKENS_SYMBOLS;
...
var makeCrawlTokenUrl = function makeCrawlTokenUrl(address) {
  return "".concat(TOKEN_METADATA_BASE_URL, "/crawlTokenData?address=").concat(address).concat(NETWORK === 4 ? '&test=true' : '');
};
...
function _crawlToken(tokenAddress) {
  return new Promise(function (resolve, reject) {
...
function () {
  ...
  _createClass(TokenMetadata, [{
    ...
    value: function crawlToken(address) {
      ...
      return _crawlToken(address).then(function (token) {
    ...
    value: function getReadableSwapOrder(orderParams, tokenByAddressParam, formatFullValueByTokenParam, parseValueByTokenParam) {
