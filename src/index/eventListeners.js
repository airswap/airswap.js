...
const trackIndexSetLocator = ({ callback, identifier, locator, fromBlock, backFillBlockCount, parser } = {}) =>
  eventTracker.trackEvent({
    callback,
    abi,
    name: 'SetLocator',
...
const trackIndexUnsetLocator = ({ callback, identifier, fromBlock, backFillBlockCount, parser } = {}) =>
  eventTracker.trackEvent({
    callback,
    abi,
    name: 'UnsetLocator',
