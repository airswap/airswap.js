...
const trackWethApproval = ({ callback, owner, spender, fromBlock, backFillBlockCount, parser } = {}) =>
...
const trackWethTransfer = ({ callback, from, to, fromBlock, backFillBlockCount, parser } = {}) =>
  eventTracker.trackEvent({
    callback,
    contract: constants.WETH_CONTRACT_ADDRESS,
    abi,
...
const trackWethDeposit = ({ callback, owner, fromBlock, backFillBlockCount, parser } = {}) =>
  eventTracker.trackEvent({
    callback,
    contract: constants.WETH_CONTRACT_ADDRESS,
    abi,
...
const trackWethWithdrawal = ({ callback, owner, fromBlock, backFillBlockCount, parser } = {}) =>
  eventTracker.trackEvent({
    callback,
    contract: constants.WETH_CONTRACT_ADDRESS,
    abi,
